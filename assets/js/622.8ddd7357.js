...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/sankeyDiagram-86f1d020.js
...
const findOrCreateNode = (ID) => {
  ID = mermaid_04fb0060.e.sanitizeText(ID, (0,mermaid_04fb0060.c)());
  if (!nodesMap[ID]) {
...
const db = {
  nodesMap,
  getConfig: () => (0,mermaid_04fb0060.c)().sankey,
  getNodes,
  getLinks,
  getGraph,
  addLink,
...
const draw = function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,mermaid_04fb0060.c)();
  const defaultSankeyConfig = mermaid_04fb0060.I.sankey;
  let sandboxElement;
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  (0,mermaid_04fb0060.o)(void 0, svg, 0, useMaxWidth);
};
const renderer = {
  draw
};
